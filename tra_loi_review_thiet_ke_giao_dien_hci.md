# Trả lời Review — Thiết kế giao diện & HCI

> **Ghi chú về đề:** Trong `Review.pdf`, phần đánh số nhảy từ **Câu 15** sang **Câu 17**. Vì vậy file này giữ nguyên thứ tự câu hỏi theo PDF và thêm mục **Câu 16 — Không có trong Review.pdf** để tránh tự bịa câu hỏi không có trong đề.
...
**Thiết kế Tương tác** (*Interaction Design*) là quá trình thiết kế cách con người tương tác với hệ thống tương tác: họ nhìn thấy gì, nhập dữ liệu ra sao, hệ thống phản hồi thế nào, họ hoàn thành nhiệm vụ bằng luồng thao tác nào, và giao diện có hỗ trợ mục tiêu thực tế của họ hay không. Nó không chỉ là “trang trí màn hình”, mà là thiết kế toàn bộ quan hệ **người dùng – nhiệm vụ – giao diện – phản hồi của hệ thống**.

Một UI tốt quan trọng vì:

1. **UI là nơi người dùng trực tiếp tiếp xúc với phần mềm.** Chức năng dù mạnh nhưng người dùng không tìm thấy, không hiểu, hoặc thao tác sai thì phần mềm vẫn thất bại.
2. **UI ảnh hưởng trực tiếp đến usability.** Tài liệu nêu usability đánh giá mức độ người dùng có thể học, sử dụng sản phẩm để hoàn thành nhiệm vụ và hài lòng với quá trình đó. UI kém làm giảm năng suất, tạo lỗi, làm người dùng bực bội và có thể khiến sản phẩm thất bại.
3. **UI chiếm tỷ trọng lớn trong vòng đời phần mềm.** Theo slide, giao diện có thể chiếm khoảng 50% thời gian thiết kế, cài đặt, bảo trì và kích thước mã nguồn.
4. **UI tốt giúp giảm chi phí hỗ trợ và đào tạo.** Khi giao diện tự nhiên, dễ học, có phản hồi rõ, có phòng lỗi và thông báo lỗi dễ hiểu, người dùng ít cần hỗ trợ hơn.
5. **UI là lợi thế cạnh tranh.** Hai phần mềm có chức năng tương tự nhau, phần mềm nào dễ dùng, nhanh, an toàn và tạo cảm xúc tốt thường được chọn nhiều hơn.
...
1. **Hiểu người dùng:** khả năng, thói quen, lỗi thường gặp, giới hạn nhận thức, trí nhớ, chú ý, học tập.
2. **Thiết kế hệ thống tương tác dễ dùng:** làm cho giao diện tự nhiên, trực quan, hiệu quả và phù hợp với bối cảnh.
3. **Giảm lỗi và rủi ro:** thiết kế để phòng lỗi, hỗ trợ undo, thông báo lỗi rõ ràng, bảo vệ dữ liệu.
4. **Đánh giá usability:** đo xem người dùng có hoàn thành nhiệm vụ chính xác, nhanh, an toàn và hài lòng không.
5. **Cải tiến quy trình phát triển:** đưa người dùng vào trung tâm của các giai đoạn thiết kế, prototype và evaluation.

---

## 3. User-Centered Design: triết lý, nguyên tắc, lợi ích và thách thức

**User-Centered Design (UCD)** là triết lý và quy trình thiết kế đặt người dùng vào trung tâm của mọi giai đoạn phát triển sản phẩm. Theo tài liệu, UCD nhằm tạo sản phẩm có usability cao bằng cách:
...
1. **Nếu có vấn đề, hãy xem hệ thống là vấn đề trước, không đổ lỗi cho người dùng.**  
   Ví dụ: người dùng không tìm thấy nút “In” không nhất thiết là họ kém; có thể vị trí hoặc nhãn nút không rõ.

2. **Người dùng kiểm soát chương trình, không phải chương trình kiểm soát người dùng.**  
   Giao diện cần cho phép hủy, quay lại, undo, thoát màn hình nhập liệu mà không lưu.

3. **Cung cấp phản hồi rõ ràng.**  
   Hệ thống cần thông báo đang xử lý, đã lưu, lỗi ở đâu, cần làm gì tiếp theo.

4. **Thông tin hướng dẫn và thông báo lỗi phải dễ hiểu, đúng ngữ cảnh.**  
   Không nên chỉ hiển thị “Error 103”; nên nói rõ lỗi và cách sửa.

5. **Thiết kế phải tự nhiên, trực quan.**  
   Giao diện nên khớp với ngôn ngữ, quy trình làm việc và kỳ vọng của người dùng.

6. **Ràng buộc và phạm vi phải rõ.**  
   Người dùng cần biết hệ thống làm được gì, không làm được gì, yêu cầu kỹ thuật nào cần có.
...
1. **Khó tuyển được nhóm người dùng tốt:** tốn chi phí, thời gian, người dùng có thể không muốn tham gia.
2. **Người dùng không phải nhà thiết kế:** không thể kỳ vọng họ tự đưa ra giải pháp thiết kế từ đầu.
3. **Người dùng không phải lúc nào cũng biết chính xác họ muốn gì:** cần quan sát hành vi thật, không chỉ hỏi ý kiến.
4. **Dễ hiểu sai dữ liệu người dùng:** nếu nhóm thiết kế quan sát kém hoặc hỏi câu hỏi dẫn dắt, yêu cầu thu được có thể sai.
5. **Có trade-off với chức năng, hiệu năng, bảo mật, chi phí và thời gian.**
...
1. **Identify needs & establish requirements — Xác định nhu cầu và thiết lập yêu cầu**
2. **Develop alternative designs — Phát triển các thiết kế thay thế**
3. **Build interactive versions — Xây dựng phiên bản tương tác/prototype**
4. **Evaluate — Đánh giá những gì đang được xây dựng**
...
**Mục tiêu:** hiểu người dùng, bối cảnh xã hội, hoạt động, artefacts/công cụ hiện có và vấn đề thật cần giải quyết.
...
- low-fidelity prototype: sketch, giấy, storyboard, flow diagram;
- medium/high-fidelity prototype: GUI design, HTML, PowerPoint, interactive GUI;
- phiên bản đủ để người dùng xem, thử và phản hồi.
...
Theo tôi, **xác định nhu cầu và thiết lập yêu cầu** là giai đoạn quan trọng nhất. Lý do: tài liệu nhấn mạnh đây là nơi lỗi thường xảy ra nhất. Nếu hiểu sai người dùng hoặc sai bài toán, các bước sau như thiết kế, prototype, code và evaluation có thể vẫn “đúng kỹ thuật” nhưng giải quyết sai vấn đề. Tuy nhiên, nói chính xác hơn, quy trình phải lặp; evaluation cũng rất quan trọng vì nó kiểm chứng lại giả định ở mọi giai đoạn.
...
1. **Người dùng có khả năng khác nhau.**  
   Có người mới dùng, có người chuyên gia, có người dùng không thường xuyên. Tài liệu nêu novice users cần learnability, infrequent users cần memorability, expert users cần efficiency.

2. **Người dùng có thói quen khác nhau.**  
...
3. **Người dùng thường mắc lỗi và nhầm lẫn.**  
   Giao diện phải có phòng lỗi, validation, undo, xác nhận thao tác nguy hiểm, thông báo lỗi rõ ràng.

4. **Người dùng bị giới hạn bởi nhận thức.**  
   Họ không chú ý được mọi thứ, không nhớ được quy trình phức tạp, dễ nhầm biểu tượng giống nhau.

5. **Người dùng sử dụng hệ thống qua giao diện.**  
   Nếu giao diện kém, họ đánh giá toàn bộ phần mềm là kém, dù backend tốt.

6. **Người dùng khác lập trình viên.**  
   Tài liệu nhấn mạnh lập trình viên thường biết nội bộ hệ thống quá rõ nên khó suy nghĩ như người dùng bình thường.
...
- **Touching — chạm:** đặc biệt quan trọng với thiết bị cảm ứng, mobile, kiosk.
...
Attention là việc chọn một số thông tin để tập trung trong rất nhiều thông tin xung quanh. Nó giúp người dùng tập trung vào nhiệm vụ nhưng cũng khiến họ bỏ sót sự kiện khác. Ví dụ trong tài liệu, người dùng có thể không để ý status bar dù có thông báo quan trọng.
...
Perception là việc nhận biết sự vật thông qua giác quan: nhìn, nghe, chạm. Trong UI, perception quyết định người dùng có đọc được chữ, phân biệt được icon, hiểu được bố cục và nhóm thông tin hay không.
...
Memory là khả năng nhớ kiến thức để hành động đúng. Người dùng không nhớ mọi thứ, đặc biệt là thủ tục phức tạp hoặc chức năng ít dùng.
...
Learning là quá trình học cách dùng ứng dụng để hoàn thành nhiệm vụ. Người dùng thường khó học qua manual và có xu hướng bỏ qua tài liệu dài.
...
Con người thường **giỏi nhận biết hơn nhớ lại**. Vì vậy, nguyên tắc thiết kế liên quan là **Recognition rather than recall** trong Nielsen Heuristics và **Reduce short-term memory load** trong Shneiderman’s Golden Rules. Nguyên tắc này quan trọng vì nó giảm tải trí nhớ, giảm lỗi và tăng tốc độ thao tác.
...
4. **Ràng buộc lỗi:** disable nút “Submit” khi form chưa hợp lệ, date picker thay vì nhập ngày tự do.
...
**Usability** là thuộc tính chất lượng đánh giá mức độ người dùng có thể **học và sử dụng sản phẩm để hoàn thành nhiệm vụ**, đồng thời **hài lòng** với quá trình đó. Usability không chỉ là “đẹp”, mà bao gồm hiệu quả nhiệm vụ, tốc độ, độ an toàn, khả năng học, khả năng nhớ lại và trải nghiệm cảm xúc.

### 9.2. Các thành phần chính của Usability

#### Effectiveness — Hiệu quả

Effectiveness là mức độ hệ thống cung cấp đủ chức năng và giúp người dùng hoàn thành nhiệm vụ **đúng và đầy đủ**. Nó gắn trực tiếp với nhu cầu người dùng.
...
Efficiency là mức độ người dùng hoàn thành nhiệm vụ **nhanh** và với ít bước sau khi đã biết dùng hệ thống. Nó liên quan đến năng suất, số bước tối thiểu và ràng buộc thời gian.
...
Ví dụ: khi xóa dữ liệu, hệ thống hỏi xác nhận; có undo; dữ liệu nhạy cảm được bảo vệ.

#### Learnability — Dễ học

Learnability là mức độ người dùng mới có thể học nhanh cách dùng hệ thống.

Ví dụ: màn hình có nhãn rõ, tutorial ngắn, thao tác phổ biến có hướng dẫn; người mới có thể dùng được trong khoảng thời gian ngắn.
...
Ví dụ: giao diện sạch, phản hồi nhanh, thông báo thân thiện giúp người dùng cảm thấy dễ chịu.
...
Một hệ thống có thể hiệu quả nhưng chưa hiệu suất: người dùng vẫn làm được việc, nhưng quá chậm. Ngược lại, hệ thống nhanh nhưng thiếu chức năng cần thiết thì không hiệu quả.

### 9.4. Ví dụ minh họa cho các thành phần Usability

1. **Safety tích cực:** form nhập ngày dùng DatePicker và kiểm tra ngày không hợp lệ. Người dùng khó nhập sai định dạng.
...
4. **Satisfaction tiêu cực:** website có màu chữ/nền tương phản kém, popup liên tục, làm người dùng khó chịu.
...
**Scenario** là câu chuyện mô tả không chính thức hoạt động của con người trong một bối cảnh cụ thể. Theo tài liệu, scenario:

- là narrative story mô tả hoạt động của con người;
...
- mô tả user-system interaction;
- use case diagram trình bày functional requirements;
...
### Ví dụ Use Case Diagram bằng Mermaid

```mermaid
flowchart LR
    BN[Bệnh nhân] --> UC1((Đăng nhập))
    BN --> UC2((Đặt lịch hẹn))
    UC2 --> UC3((Chọn chuyên khoa))
    UC2 --> UC4((Chọn bác sĩ))
    UC2 --> UC5((Chọn ngày giờ khám))
    UC2 --> UC6((Xác nhận lịch hẹn))
    UC6 --> UC7((Gửi thông báo xác nhận))
```
...
**Prototype** là bản trình bày thiết kế trước khi phiên bản cuối được code. Prototype giúp khách hàng/người dùng nhìn thấy và tương tác với sản phẩm ở giai đoạn sớm. Tài liệu nhấn mạnh prototype nhanh và rẻ hơn code thật, giúp lựa chọn giữa các phương án thiết kế.

### 12.2. Vì sao cần prototype?

1. **Phát hiện lỗi sớm:** lỗi phát hiện càng muộn thì chi phí sửa càng cao.
2. **Thử nhiều ý tưởng rẻ:** đặc biệt với low-fidelity prototype.
3. **Thu phản hồi từ người dùng sớm:** người dùng dễ góp ý khi nhìn thấy giao diện cụ thể.
4. **So sánh phương án:** nhóm thiết kế có thể chọn phương án tốt hơn.
5. **Làm rõ yêu cầu:** prototype dựa trên scenario và use case giúp kiểm tra yêu cầu có hợp lý không.
6. **Giảm rủi ro code sai:** tránh đầu tư nhiều vào chức năng/giao diện không hữu ích.
...
2. **Khớp form với tài liệu nguồn thực tế.**  
   Ví dụ: form nhập hóa đơn nên có cấu trúc gần với hóa đơn giấy.
3. **Chỉ nhập dữ liệu cần thiết.**  
   Tránh bắt người dùng nhập trường không phục vụ nghiệp vụ.
4. **Có giá trị mặc định.**  
   Ví dụ: ngày lập phiếu mặc định là hôm nay.
5. **Hiển thị danh sách giá trị cho trường chọn được.**  
   Ví dụ: combobox cho tỉnh/thành, trạng thái đơn hàng.
6. **Tab order đúng.**  
   Người dùng bấm Tab phải đi theo thứ tự nhập tự nhiên.
7. **Nhãn trường rõ ràng.**
8. **Cung cấp ví dụ cho yêu cầu đặc biệt.**  
   Ví dụ: “Số điện thoại: 09xxxxxxxx”.
9. **Luôn cho phép thoát màn hình nhập mà không lưu.**
10. **Error prevention và data validation.**  
    Kiểm tra định dạng, bắt buộc, giới hạn giá trị, kiểu dữ liệu.
...
Theo tài liệu, report design nên:
...
7. **Phù hợp đầu ra:** in giấy, PDF, file hoặc màn hình.
...
**Controls/Widgets** là các thành phần giao diện tái sử dụng, xử lý cả input và output, có event handling như callback/listener. Các control có thể khác style theo hệ điều hành hoặc framework.

| Nhóm control | Chức năng chính | Ví dụ |
|---|---|---|
| Container | Chứa và tổ chức các control khác | Dialog/form modal, dialog modeless, Panel, FlowLayoutPanel, TableLayoutPanel, TabControl |
...
| Commands | Kích hoạt hành động | Button, Menu, Context menu, Toolbar, Hyperlink, Ribbon |
...
1. Chọn control phù hợp với kiểu dữ liệu: danh sách hữu hạn dùng combobox/radio, dữ liệu dài dùng textarea.
...
1. **Mục tiêu nhiệm vụ của màn hình**  
   Màn hình dùng để nhập, xem danh sách, xem chi tiết, báo cáo hay điều hướng?

2. **Menu và điều hướng**  
   Menu phải chứa đủ chức năng hệ thống. Có thể nhóm theo:
   - đặc điểm IT: File, Edit, Tools;
   - đối tượng nghiệp vụ: Library, Book, Reader;
   - logic nghiệp vụ: Manage Book, Manage Reader.
...
8. **Tính nhất quán**  
   Các màn hình cùng loại nên có cấu trúc, thuật ngữ và vị trí nút tương tự.
...
Nếu chỉ “tiện lợi” nhưng sai nghiệp vụ thì hệ thống nguy hiểm. Nếu “đúng” nhưng khó dùng thì hệ thống vẫn cần cải tiến usability.

---

## 16. Không có nội dung trong Review.pdf

Trong file `Review.pdf` được đính kèm, phần đánh số câu hỏi bỏ qua **Câu 16**: sau Câu 15 là trực tiếp đến **Phần 6: Đánh giá** và **Câu 17**. Vì vậy không có câu hỏi số 16 để trả lời. Các phần còn lại giữ đúng số thứ tự theo đề.
...
Theo tài liệu, usability evaluation có hai mục tiêu chính:

1. **Cung cấp phản hồi trong quá trình thiết kế để tạo thiết kế tốt hơn.**
2. **Đánh giá mức độ usable của sản phẩm.**

Nói cách khác, evaluation giúp phát hiện vấn đề usability, hiểu nguyên nhân, ưu tiên sửa lỗi và kiểm chứng thiết kế có đáp ứng người dùng hay không.
...
1. **Determine overall goals — Xác định mục tiêu tổng quát**  
   Ví dụ: đánh giá người dùng có đặt lịch khám dễ dàng không.

2. **Explore specific questions — Xây dựng câu hỏi cụ thể**  
   Ví dụ: người dùng có tìm được bác sĩ không? Có hiểu thông báo lỗi không?

3. **Choose evaluation methods — Chọn phương pháp đánh giá**  
   Ví dụ: heuristic evaluation, lab-based usability testing, interview, questionnaire.

4. **Identify practical issues — Xác định vấn đề thực tế**  
   Bao gồm evaluator, participant, thiết bị, phòng lab, thời gian, chi phí.

5. **Decide ethical issues — Xử lý vấn đề đạo đức**  
   Ẩn danh, quyền của người tham gia, informed consent form.

6. **Evaluate the data — Đánh giá dữ liệu**  
   Xác định dữ liệu cần thu, thống kê, bias, validity, cách trình bày kết quả và bước xử lý tiếp theo.
...
**Heuristic Evaluation** là phương pháp đánh giá giao diện dựa trên các quy tắc/heuristics, thường là 10 usability heuristics của Jakob Nielsen. Tài liệu nêu phương pháp này không cần người dùng và thường có 3–5 evaluator làm việc độc lập trên UI.
...
1. **Xác định mục tiêu test.**  
   Ví dụ: người dùng có đặt lịch khám trong dưới 3 phút không?

2. **Chọn participant đại diện.**  
   Người tham gia nên giống nhóm người dùng mục tiêu.

3. **Chuẩn bị kịch bản/nhiệm vụ.**  
   Ví dụ: “Hãy tìm một bác sĩ da liễu và đặt lịch vào tuần sau.”

4. **Chuẩn bị môi trường lab.**  
   Máy tính/điện thoại, phần mềm ghi màn hình, camera, biểu mẫu ghi chú.

5. **Giới thiệu và xin consent.**  
   Giải thích mục tiêu, quyền của người tham gia, đảm bảo ẩn danh.

6. **Cho người dùng thực hiện nhiệm vụ.**  
   Có thể yêu cầu think-aloud nếu phù hợp.

7. **Thu dữ liệu.**  
   Thời gian hoàn thành, số lỗi, bước bị kẹt, tỉ lệ thành công, nhận xét, cảm xúc.
...
4. **Cẩn thận với thang đo:** số mức, nhãn hai đầu, hướng điểm phải rõ.
5. **Tránh jargon/thuật ngữ chuyên môn khó hiểu.**
6. **Tránh câu hỏi chủ quan/dẫn dắt.**
7. **Cung cấp hướng dẫn rõ.**
8. **Không hỏi kiểu gây thiên lệch.**  
   Ví dụ xấu: “Website này xấu, đúng không?”
...
12. **Kết hợp câu hỏi chung và câu hỏi theo scenario.**  
    Tài liệu gợi ý khoảng 50% câu hỏi về thiết kế/chức năng chung và 50% câu hỏi dựa trên kịch bản sử dụng.

---

## 19. Phân tích kết quả đánh giá và ưu tiên vấn đề usability theo severity

Sau khi thu thập dữ liệu, không nên phản ứng kiểu “người dùng ngu” hoặc “do developer X”. Phản ứng đúng là: **làm thế nào redesign UI để giải quyết vấn đề usability này?** Dữ liệu và người dùng cần được xem là căn cứ để cải tiến.
...
Thiết kế mobile và desktop đều phải đảm bảo usability, nhưng khác nhau ở bối cảnh, thiết bị nhập/xuất, kích thước màn hình và kỳ vọng người dùng.

| Yếu tố | Mobile | Desktop |
|---|---|---|
| Kích thước màn hình | Nhỏ, cần ưu tiên nội dung chính, tránh quá nhiều cột | Rộng hơn, có thể hiển thị nhiều vùng: sidebar, table, detail |
...
| Hiển thị dữ liệu | Tránh bảng lớn, dùng card/list, drill-down | Bảng dữ liệu lớn, multi-pane, master-detail |
...
| Accessibility | Kích thước tap target, contrast, one-hand use | Keyboard navigation, screen reader, zoom, shortcut |

### Các yếu tố cần cân nhắc khi thiết kế mobile

1. **Ưu tiên nhiệm vụ chính.**  
   Không đưa toàn bộ chức năng desktop lên cùng một màn hình mobile.

2. **Tap target đủ lớn.**  
   Nút quá nhỏ gây lỗi thao tác, ảnh hưởng safety.

3. **Giảm nhập liệu.**  
   Dùng default value, picker, autocomplete, scan, voice input nếu phù hợp.

4. **Thiết kế theo ngữ cảnh bị gián đoạn.**  
   Lưu trạng thái, cho phép quay lại, autosave.

5. **Phản hồi rõ ràng.**  
   Không dựa vào hover; cần pressed state, loading, toast.

6. **Tối ưu performance và offline/poor network.**

7. **Tuân theo platform conventions.**  
   iOS/Android có quy ước navigation, gesture và permission khác nhau.
...
- Hamburger menu trên mobile có thể làm giảm visibility.
...
- Form dài làm tăng cognitive load.
...
- Có thể kết hợp autocomplete, filter, sorting để tăng efficiency.
...
Ví dụ: chỉnh sửa video, CAD, IDE, phần mềm đồ họa, phân tích dữ liệu lớn. Native app thường kiểm soát tài nguyên tốt hơn và phản hồi nhanh hơn.
...
Ví dụ: camera, GPS, Bluetooth, file system, notification, clipboard nâng cao, thiết bị ngoại vi, cảm biến.

### 4. Tác vụ thường xuyên, dài và phức tạp

Nếu người dùng dùng hàng ngày trong phiên dài, cần phím tắt, multi-window, thao tác nhanh, custom control, Application UI phù hợp hơn.

### 5. Cần trải nghiệm rất nhất quán với nền tảng

Ví dụ: app mobile cần tuân theo chuẩn iOS/Android; desktop app cần menu, shortcut, system tray, drag-and-drop file.

### 6. Cần bảo mật hoặc kiểm soát dữ liệu cục bộ đặc biệt

Một số hệ thống doanh nghiệp, y tế, ngân hàng hoặc nội bộ có thể cần kiểm soát môi trường chạy, lưu trữ cục bộ, mã hóa, tích hợp xác thực thiết bị.

### 7. Cần tích hợp sâu với workflow chuyên nghiệp

Ví dụ: phần mềm kế toán, quản lý bệnh viện, POS, phần mềm dựng phim, IDE. Các hệ thống này thường cần nhiều control mạnh như grid, ribbon, tree view, shortcut, report, import/export.
...
- mục tiêu là reach rộng và triển khai nhanh.

Kết luận: Application UI phù hợp với **tác vụ nặng, thường xuyên, cần offline, cần native capability và workflow phức tạp**. Web UI phù hợp với **khả năng truy cập rộng, triển khai nhanh, ít cài đặt và sử dụng không quá chuyên sâu**.
